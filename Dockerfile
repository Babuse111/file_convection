...
# Command to run the application using the Gunicorn production server with increased timeout and logging.
CMD gunicorn --bind 0.0.0.0:$PORT --timeout 120 --log-level debug --error-logfile - wsgi:app
